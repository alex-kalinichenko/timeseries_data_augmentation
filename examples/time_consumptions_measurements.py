...
if __name__ == "__main__":
    """
    run tabgan and our approach experiments and measure time of data augmentation procedure
    """

    df, train_test_split = get_data_from_file(
        os.path.join(os.path.join("data", "df_678.csv"))
        # os.path.join(os.path.join("data", "df_long0945.csv"))
    )
    d = df
    ...
    print()
    print("augmentation time consumpted:", augm_time / n)
    print("tabgan time consumpted:   ", tabgan_time / n)
